# 🚚 Operasyonel & Finansal KPI Analizi, Pazar İçgörüleri ve Servis Alanı Optimizasyonu
...
CBS, veri bilimi, pazarlama ve iş zekâsı alanları bir araya getirilerek veri odaklı yaklaşımlar gerçekleştirilmiştir.
...
- **DEM Verisi** → Sayısal Yükseklik modeli verisi
